  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Language text */}
        <span className="relative z-10 text-sm font-medium text-primary transition-colors duration-300 group-hover:text-primary/80">
          {language === 'en' ? 'हिंदी' : 'English'}
        </span>
        
        {/* Animated indicator */}
        <div className="relative z-10 w-2 h-2 rounded-full bg-primary/60 group-hover:bg-primary transition-colors duration-300" />
      ...
      {/* Tooltip */}
      <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-1 bg-slate-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap z-50">
